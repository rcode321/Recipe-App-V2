...
import AdoboImg from "./Adoboimg.jpg";
import {
	MealsContainer,
	MealsWrapper,
	MealsImage,
	...
	return (
		<div>
			<MealsContainer>
				<MealsWrapper>
					<MealsImage>
						<Img src={AdoboImg} alt="Personalized Chicken meal" />
					</MealsImage>
					<MealsContent>
						<MealsContentTitle>Personalize your Meals</MealsContentTitle>
						<MealsContentText>
							Choose your weekly or daily meal plan from our meals to kick start your
							month. All meanu are fresh and set for you in portion to make it easier
							to cook immediately.
						</MealsContentText>
						<MealsContentItems>
							<MealsContentList>
